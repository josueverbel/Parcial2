        ...
        <div id="wrapper">
			<div class="container-fluid">	
                <div class="row mb-5">
                    ...
                    <a class="btn btn-primary" href="<?php echo $estearchivo;?>?action=new">Nuevo Cliete</a>
                </div>			
				<div class="row">
                    ...
                    <div class="col-6 border">
                        ...
                        <table border="0" style=" color: white; font-weight: bold; background: black; width: 100%; border-radius: 10px; text-align: center;">
										...
										<?php foreach ($miArray as $indice => $valor){
														...
														<tr>
															...
															<td> 
																<form name="borrar" method="post">
																	<button name="btn_borrar" value="<?php echo $indice; ?>" class="btn btn-lg" style=" color: white; font-weight: bold; background: black; width: 100%;">
																		<img src="img/2.png" width="30px">
																	</button>
																</form>
															</td>
															<td>
																<form name="actualizar" method="post" action="<?php echo $estearchivo;?>">
																	<button name="btn_actualizar" value="<?php echo $indice; ?>" class="btn btn-lg" style=" color: white; font-weight: bold; background: black; width: 100%;">
                    ...
                    <div class="col-6">
                        <?php 
                        //verificando que esta llegando el indice ustedes hace el resto
                        echo "El indice a editar es ".$_POST['btn_actualizar'];?>
                        <div class="card shadow mb-4">
							<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
